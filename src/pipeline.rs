...
#[derive(Default)]
pub struct PaniniBindGroupCache {
    cached: Option<(TextureViewId, BindGroup)>,
}

// This contains global data used by the render pipeline. This will be created once on startup.
#[derive(Resource)]
pub struct PaniniPipeline {
...
pub fn post_process_system(
    view: ViewQuery<(
        &ViewTarget,
        &PaniniShaderSettings,
        &DynamicUniformIndex<PaniniShaderSettings>,
    )>,
    post_process_pipeline: Option<Res<PaniniPipeline>>,
    pipeline_cache: Res<PipelineCache>,
    settings_uniforms: Res<ComponentUniforms<PaniniShaderSettings>>,
    mut cache: Local<PaniniBindGroupCache>,
    ...
    let mut render_pass = ctx
        ...
        .begin_render_pass(&RenderPassDescriptor {
            label: Some("Panini post_process_pass"),
